...
<g:if test="${show_gwas}">
    <p>
        There are <strong><span id="totalGwasVariants"></span> total variants</strong> within 500 kb of this gene in GWAS data available on this portal
    | <a id="totalGwasVariantAnchor" class="variantlink" >view</a>
    </p>
    <ul>
        <li>
            <span id="diabetesAtOrAboveGwas"></span>
            ...
            %{--<g:if test="${(gene_info.GWAS_T2D_GWS_TOTAL > 0)}">--}%
                %{--print('</strong>');--}%
            %{--</g:if>--}%
            | <a id="diabetesAtOrAboveGwasAnchor" class="variantlink">view</a>
        </li>
        %{--<li>--}%
